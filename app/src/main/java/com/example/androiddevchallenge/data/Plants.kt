...
data class Plants(val url: String, val name: String, val description: String)

val listOfPlants = listOf<Plants>(
    Plants(
    ...
    Plants(
        "https://images.pexels.com/photos/6208087/pexels-photo-6208087.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260",
        "Fiddle Leaf Tree",
        "This is description"
    ),
    Plants(
